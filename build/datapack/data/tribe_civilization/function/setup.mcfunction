...
tellraw @s [{"text":"Don't forget to add [adventure zones], they have been reset!","color":"red","clickEvent":{"action":"suggest_command","value":"/function tribe_civilization:utils/adventure_zone_add {x: 0, y: 0, z: 0, dx: 0, dy: 0, dz: 0}"}}]

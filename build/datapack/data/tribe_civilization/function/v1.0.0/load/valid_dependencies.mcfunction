...
execute if score #dependency_error tribe_civilization.data matches 1 unless score #iyc.major load.status matches 1.. run tellraw @a {"translate":"tribe_civilization.imagineyourcraft_v1_2_0","color":"gold","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/ImagineYourCraft"}}
execute if score #dependency_error tribe_civilization.data matches 1 if score #iyc.major load.status matches 1 unless score #iyc.minor load.status matches 2.. run tellraw @a {"translate":"tribe_civilization.imagineyourcraft_v1_2_0","color":"gold","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/ImagineYourCraft"}}

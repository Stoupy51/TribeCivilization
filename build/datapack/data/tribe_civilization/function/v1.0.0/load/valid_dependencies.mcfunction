...
execute if score #dependency_error tribe_civilization.data matches 1 unless score #smithed.crafter.major load.status matches 0.. run tellraw @a {"translate":"tribe_civilization.smithed_crafter_v0_6_2","color":"gold","clickEvent":{"action":"open_url","value":"https://wiki.smithed.dev/libraries/crafter/"}}
execute if score #dependency_error tribe_civilization.data matches 1 if score #smithed.crafter.major load.status matches 0 unless score #smithed.crafter.minor load.status matches 6.. run tellraw @a {"translate":"tribe_civilization.smithed_crafter_v0_6_2","color":"gold","clickEvent":{"action":"open_url","value":"https://wiki.smithed.dev/libraries/crafter/"}}
...
execute if score #dependency_error tribe_civilization.data matches 1 unless score #furnace_nbt_recipes.major load.status matches 1.. run tellraw @a {"translate":"tribe_civilization.furnace_nbt_recipes_v1_8_0","color":"gold","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/FurnaceNbtRecipes"}}
execute if score #dependency_error tribe_civilization.data matches 1 if score #furnace_nbt_recipes.major load.status matches 1 unless score #furnace_nbt_recipes.minor load.status matches 8.. run tellraw @a {"translate":"tribe_civilization.furnace_nbt_recipes_v1_8_0","color":"gold","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/FurnaceNbtRecipes"}}

...
execute as @a[gamemode=!spectator,predicate=tribe_civilization:chance/0.01] at @s positioned over world_surface if entity @s[distance=..5] run function tribe_civilization:falling_stars/selected_players

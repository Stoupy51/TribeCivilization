...
execute if score #total_vanilla_cobblestone your_namespace.data matches 1.. if entity @s[tag=your_namespace.vanilla.minecraft_cobblestone] unless block ~ ~ ~ minecraft:cobblestone run function your_namespace:custom_blocks/_groups/minecraft_cobblestone
